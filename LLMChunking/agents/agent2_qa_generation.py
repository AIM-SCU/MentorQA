...
class QAGenerationAgent:
    ...
    def run_agent2_qa_generation(
        self, segment_text: str, num_questions: int
    ) -> List[Dict]:
        ...
        system_prompt = (
            f"You are a {lang_name} expert content analyst. Your task is to read a long transcript and identify potential questions that cover the most important educational and mentorship value."
            f"{lang_guard}"
        )
