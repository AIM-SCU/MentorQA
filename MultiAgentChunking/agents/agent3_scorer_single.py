...
class Scorer:
    ...
    def run_agent3_scorer_single(self, question: str, context_hint: str) -> float:
        """
        Score a single question 1-10 for educational value.
        ...
        system_prompt = (
            "You are an expert content evaluator. Return ONLY a number 1-10."
        )
        prompt = f"""Rate the following question for educational value (1=poor, 10=excellent). 
        Question: {question}
        Hint: {context_hint}. 
